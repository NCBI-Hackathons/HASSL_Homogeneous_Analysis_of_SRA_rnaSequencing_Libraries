...
rule hisat_alignment_one: 
	...
	shell: "hisat -D 15 -R 2 -N 0 -L 22 -i S,1,1.15 -x {HISATREF} -p {threads} --sra-acc {sample} --mm -t --novel-splicesite-outfile {sample}.GRCh38.p4.hisat.novel.splicesites.txt > /dev/null  2> {sample}.GRCh38.p4.hisat.one.log"
